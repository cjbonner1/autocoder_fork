...
This command **requires** the project directory as an argument via `/Users/otchance/repos/autocoder_fork`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/otchance/repos/autocoder_fork/prompts/app_spec.txt` and `/Users/otchance/repos/autocoder_fork/prompts/initializer_prompt.md`

If `/Users/otchance/repos/autocoder_fork` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/otchance/repos/autocoder_fork/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/otchance/repos/autocoder_fork/prompts/app_spec.txt`
...
**Output path:** `/Users/otchance/repos/autocoder_fork/prompts/initializer_prompt.md`
...
**Output path:** `/Users/otchance/repos/autocoder_fork/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/otchance/repos/autocoder_fork/prompts/`!
>
> **Files created:**
> - `/Users/otchance/repos/autocoder_fork/prompts/app_spec.txt`
> - `/Users/otchance/repos/autocoder_fork/prompts/initializer_prompt.md`
>
